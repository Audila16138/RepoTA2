...
export default function GuestBrowse() {
  ...
  return (
    <div className="space-y-6 flex flex-col items-center text-center">
      ...
      {/* Search — centered, icon vertically centered */}
      <div className="relative w-full max-w-lg">
        ...
        <input className="input pl-11 py-3 text-sm w-full" placeholder="Cari judul tugas akhir..."
      ...
      {/* Grid — left aligned content, full width */}
